<x-app-layout>
    <main class="container mx-auto py-12 px-4">
        ...
        <!-- Categoría: Ebooks-->
        <section class="mb-12">
            <h2 class="text-3xl font-bold mb-6 text-black">Ebooks</h2>
            <p class="text-xl text-gray-700 mb-6">
                Nuestros ebooks abordan temas clave en programación y desarrollo web, brindándote conocimientos profundos y prácticos para avanzar en tu carrera.
            </p>
            <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach( $ebookProducts as $product )
        ...
        <!-- Categoría: Descargables -->
        <section class="mb-12">
            <h2 class="text-3xl font-bold mb-6 text-black">Descargables</h2>
            <p class="text-xl text-gray-700 mb-6">
                Accede a herramientas y recursos descargables que facilitarán tu proceso de desarrollo y te ahorrarán tiempo en tus proyectos.
            </p>
            <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach( $uploadProducts as $product )
                    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        <a  href="{{route('product_show',['slug' => $product->slug])}}">
                            <img class="p-8 rounded-t-lg"src="{{asset('/storage/'.$product->image_url)}}" alt="{{$product->title}}"/>
                        </a>
        ...
        <!-- Categoría: Cursos -->
        <section class="mb-12">
            <h2 class="text-3xl font-bold mb-6 text-black">Otros Recursos</h2>
            <p class="text-xl text-gray-700 mb-6">
                Encuentra cursos, webinars y otros materiales que complementarán tu formación y te mantendrán a la vanguardia de la industria.
            </p>
            <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
