        ...
        <section class="text-center mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-white shadow p-6 rounded-lg">
                    ...
                    <p class="mb-3 text-gray-600 dark:text-gray-700 first-line:uppercase first-line:tracking-widest first-letter:text-7xl first-letter:font-bold first-letter:text-gray-900 dark:first-letter:text-gray-900 first-letter:me-3 first-letter:float-start">Mi misión es compartir mi experiencia y conocimientos para ayudar a otros desarrolladores a mejorar sus habilidades y alcanzar su máximo potencial. Creo firmemente en el poder de la comunidad y en la importancia de crecer juntos en este apasionante mundo del desarrollo.</p>
                </div>
                <div class="bg-white shadow p-6 rounded-lg">
                    <h3 class="text-2xl font-bold mb-4 text-black">Transformar Vidas a Través del Código</h3>
                    <p class="mb-3 text-gray-600 dark:text-gray-700 first-line:uppercase first-line:tracking-widest first-letter:text-7xl first-letter:font-bold first-letter:text-gray-900 dark:first-letter:text-gray-900 first-letter:me-3 first-letter:float-start">Aspiro a facilitar la entrada de más personas al sector de la programación, brindándoles las herramientas y el conocimiento necesario para mejorar sus vidas. Mi visión es construir una comunidad inclusiva donde el aprendizaje y la innovación sean accesibles para todos.</p>
                </div>
            </div>
        </section>
